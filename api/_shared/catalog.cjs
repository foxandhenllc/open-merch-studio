...
function buildQuote(inputItems) {
  ...
  return {
    ...
    paymentFeeCents,
    targetMarginCents,
    totalCents: itemRetailBeforeFees + shippingEstimateCents + paymentFeeCents,
  ...
  return {
    ...
    readiness: {
      ...
      checks: [
        ...
        { label: 'Prompt specificity', result: normalizedPrompt.length < 12 ? 'Add more subject and style detail before production.' : 'Prompt has enough detail for a first-pass artwork draft.' },
