...
Activation remains intentionally supervised: verify the sender domain, configure the Printful
webhook key pair, run signed production fixtures, and add scheduled reconciliation before describing
