...
export const foxHenProducts: ExampleProduct[] = [
  ...
  },
  {
    ...
    description:
      'The approved stacked lockup leads; the clean ampersand studio seal and an operating principle live on the reverse.',
  ...
  },
  {
    ...
    description: 'The horizontal logo and clean ampersand studio seal meet across a restrained full-color wrap.',
  ...
  },
  {
    ...
    description: 'The clean ampersand studio seal becomes a durable three-inch studio sticker.',
